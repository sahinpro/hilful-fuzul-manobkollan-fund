...
export const DEFAULT_SITE_LOCALE: SiteLocale = "bn";

export const SITE_LOCALE_STORAGE_KEY = "site-locale";
export const SITE_LOCALE_COOKIE = "site-locale";

export const SITE_LOCALES: readonly SiteLocale[] = ["bn", "en"] as const;
...
export function browserDefaultSiteLocale(): SiteLocale {
  ...
  return lang.startsWith("en") ? "en" : DEFAULT_SITE_LOCALE;
}
