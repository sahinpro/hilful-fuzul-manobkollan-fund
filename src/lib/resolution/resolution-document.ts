...
const BN: ResolutionDocumentContent = {
  ...
  proposalBody:
    "অদ্য তালেরতল গ্রামের গণ্যমান্য ব্যক্তিবর্গ এবং ধর্মপ্রাণ যুবসমাজের উপস্থিতিতে এক জরুরি সভা অনুষ্ঠিত হয়। গ্রামের সামাজিক উন্নয়ন, দুস্থ ও অসহায় মানুষের সেবায় একটি সুশৃঙ্খল তহবিল ও সংগঠন গঠনের লক্ষ্যে এই সভার আয়োজন করা হয়। সভার শুরুতে পবিত্র কোরআন তেলাওয়াতের পর সভাপতি মহোদয় স্বাগত বক্তব্যের মাধ্যমে সভার কাজ শুরু করেন।",
  agendaTitle: "২. আলোচ্য বিষয়সমূহ",
  agendaItems: [
    "'হিলফুল ফুজুল মানবকল্যাণ সংগঠন' গঠন এবং এর কমিটি প্রণয়ন।",
    "সংগঠনের লক্ষ্য, উদ্দেশ্য ও নীতিমালা নির্ধারণ।",
    "সংগঠনের তহবিল সংগ্রহ ও পরিচালনা পদ্ধতি।",
  ],
  decisionsTitle: "৩. গৃহীত সিদ্ধান্ত ও প্রস্তাবনাসমূহ",
  decisions: [
    {
      label: "১ নং প্রস্তাব ও সিদ্ধান্ত:",
      body: 'সভায় উপস্থিত সকলের সর্বসম্মতিক্রমে গ্রামের অসহায় ও দরিদ্র মানুষের পাশে দাঁড়ানোর লক্ষ্যে **"হিলফুল ফুজুল মানবকল্যাণ সংগঠন"** নামে একটি অরাজনৈতিক ও জনকল্যাণমূলক সংগঠনের আনুষ্ঠানিক আত্মপ্রকাশ ঘটে।',
    },
    {
      label: "২ নং প্রস্তাব (সভাপতি নির্বাচন):",
      body: "জনাব মো: মোহাম্মদ আলী সাহেব প্রস্তাব করেন যে, **মো: শামসুদ্দিন** সাহেবকে অত্র সংগঠনের সভাপতি পদে মনোনীত করা হোক। উপস্থিত সকলে সমস্বরে তা সমর্থন করেন এবং তিনি সভাপতি হিসেবে নির্বাচিত হন।",
    },
    {
