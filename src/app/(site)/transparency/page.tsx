...
export default async function TransparencyPage() {
  ...
  return (
    ...
    >
      <RevealGroup className="grid gap-4 md:grid-cols-3" staggerMs={65} delayChildrenMs={35}>
        <Card className="ios-card shadow-sm">
          ...
          <CardContent>
            <p className="text-2xl font-bold">
              {formatPublicBdt(donationTotal, locale)}
            </p>
        ...
        <Card className="ios-card shadow-sm">
          ...
          <CardContent>
            <p className="text-2xl font-bold">
              {formatPublicBdt(expenseTotal, locale)}
            </p>
        ...
        <Card className="ios-card shadow-sm">
          ...
          <CardContent>
            <p className="text-2xl font-bold">
              {formatPublicBdt(balance, locale)}
            </p>
            <CardDescription className="mt-1">
            ...
            <thead className="bg-muted">
              <tr>
                <th className="px-4 py-3 font-semibold">
                  {t("pages.transparency.table.date")}
                </th>
                <th className="px-4 py-3 font-semibold">
                  {t("pages.transparency.table.kind")}
                </th>
                <th className="px-4 py-3 font-semibold">
                  {t("pages.transparency.table.description")}
                </th>
                <th className="px-4 py-3 font-semibold">
                  {t("pages.transparency.table.amount")}
                </th>
              </tr>
            </thead>
            <tbody>
